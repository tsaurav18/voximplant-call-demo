...
export default class CallManager {
  ...
  getCallById(callId) {
    console.log(
      'into callManager.js file to check callid is here or not to call the getcallbyid() function <>>>>>',
      callId,
    );
    if (this.call && callId === this.call.callId) {
      console.log('return the call into  getcallbyid function()', this.call);
